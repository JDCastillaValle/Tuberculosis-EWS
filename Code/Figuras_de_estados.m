%% Verisón rápida, cargando estados estables
%{
%% Parámetros
tic
close all
...
k2 = min(umbral);%1.68164470296576e-09;
%}
...
%% Se cargan estados estables e inestables, los estables se categorizan 

%{
%load('M_sol_stable_ph2.mat')
%load('M_sol_unstable_ph2.mat')
%load('Mf_sol_stable_ph2.mat')
%load('Mf_sol_unstable_ph2.mat')
%load('T_sol_stable_ph2.mat')
%load('T_sol_unstable_ph2.mat')
%load('Tf_sol_stable_ph2.mat')
%load('Tf_sol_unstable_ph2.mat')
%}

load('C:\Users\José Daniel\Documents\Tesis\ph2\M_sol_stable_ph2_in_order.mat')
load('C:\Users\José Daniel\Documents\Tesis\ph2\M_sol_unstable_ph2_in_order.mat')
load('C:\Users\José Daniel\Documents\Tesis\ph2\Mf_sol_stable_ph2_in_order.mat')
load('C:\Users\José Daniel\Documents\Tesis\ph2\Mf_sol_unstable_ph2_in_order.mat')
load('C:\Users\José Daniel\Documents\Tesis\ph2\T_sol_stable_ph2_in_order.mat')
load('C:\Users\José Daniel\Documents\Tesis\ph2\T_sol_unstable_ph2_in_order.mat')
load('C:\Users\José Daniel\Documents\Tesis\ph2\Tf_sol_stable_ph2_in_order.mat')
load('C:\Users\José Daniel\Documents\Tesis\ph2\Tf_sol_unstable_ph2_in_order.mat')
...
%% Parámetros de fagocitación y figura de estados estables

k2=[1e-10, .75e-10, .5e-10, .25e-10, ...
...
k2 = sort(k2); % Lo ordenamos si cargamos los estados "in_order"

figure
sgtitle('Real stable states greater than zero')
subplot(2,2,1)
hold on
scatter(log10(k2), M_sol_stable_1, 'filled', 'o', 'g')
scatter(log10(k2), M_sol_stable_2, 'filled', 'o', 'r')
line([log10(2.985e-7), log10(2.985e-7)], [0, 2.5e9], 'Color', 'k', 'LineStyle', '--') ;%1.01382645792285e-10*184.71337580; % fagocitosis
...
line([log10(2.985e-7), log10(2.985e-7)], [0, 2.5], 'Color', 'k', 'LineStyle', '--') ;%1.01382645792285e-10*184.71337580; % fagocitosis
...
line([log10(2.985e-7), log10(2.985e-7)], [0, 11e6], 'Color', 'k', 'LineStyle', '--') ;%1.01382645792285e-10*184.71337580; % fagocitosis
...
line([log10(2.985e-7), log10(2.985e-7)], [0, 1], 'Color', 'k', 'LineStyle', '--') ;%1.01382645792285e-10*184.71337580; % fagocitosis
