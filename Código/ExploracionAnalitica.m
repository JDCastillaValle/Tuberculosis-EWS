...
%Modulables, actualmente esta en fase 2
...
sol_3=[0,0,k15,0]; % dos eigenvalores dependientes de fagocitosis pero uno siempre es positivo, el segundo siempre es negativo

sol_4=[0,0,k15,1]; % dos eigenvalores dependientes de fagocitosis, los dos restantes siempre son negativos

%% para veirificar la estabilidad usamos la jacobiana
