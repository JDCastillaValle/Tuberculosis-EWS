...
%% Tenemos 4 soluciones positivas reales
sol_1=[0,0,0,0]; % independiente de fagocitosis, siempre inestable

sol_2=[0,0,0,1]; % independiente de fagocitosis, siempre inestable

sol_3=[0,0,k15,0]; % dos eigenvalores dependientes de fagocitosis, uno siempre positivo y el otro siemprenegativo

sol_4=[0,0,k15,1]; % dos eigenvalores dependientes de fagocitosis, los dos restantes siempre negativos

%% llamamos a la matriz jacobiana
...
%% Evaluamos la matriz jacobiana en la solución 4
%% Y resolvemos la ecuación de Lyapunov con la función lyap
